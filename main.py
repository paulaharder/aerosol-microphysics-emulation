...
def main(args):
    ...
    if args.mode == 'train_with_all':
        X_test = np.load('../keras-emulator/data/'+args.dataset+'/X_test.npy')
        y_test = np.load('../keras-emulator/data/'+args.dataset+'/y_test.npy')
        X_val = np.load('../keras-emulator/data/'+args.dataset+'/X_val.npy')
        y_val = np.load('../keras-emulator/data/'+args.dataset+'/y_val.npy')
    ...
    #X_train[np.abs(X_train)<eps]=0
    #X_test[np.abs(X_test)<eps]=0
    #y_train[np.abs(y_train)<eps]=0
    #y_test[np.abs(y_test)<eps]=0
